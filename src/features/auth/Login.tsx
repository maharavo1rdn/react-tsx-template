...
export default function Login() {
    ...
    return (
        <main className="flex min-h-dvh items-center justify-center bg-background px-4 py-8">
            <section className="grid w-full max-w-5xl overflow-hidden rounded-lg border border-slate-100 bg-white shadow-[0_24px_70px_rgba(15,23,42,0.08)] lg:grid-cols-[0.95fr_1.05fr]">
