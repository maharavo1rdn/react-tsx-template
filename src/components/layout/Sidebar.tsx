      ...
      >
        <div className="flex min-h-18 items-center gap-3 px-4">
          ...
          <button
            ...
            className="hidden h-9 w-9 items-center justify-center rounded-lg text-slate-500 transition hover:bg-primary-subtle hover:text-sky-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/25 lg:inline-flex"
